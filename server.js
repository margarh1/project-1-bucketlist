...
app.get('/user/:username', function wishlist(req, res) {
	User.findOne({
		...
		//TODO: If you're trying to find a user and user doesn't exist, we're still going to their page?
		res.render('user', {
			user: foundUser
		});
	});
...
app.get('/api/user', function (req, res) {
	db.User.find({}, function (err, allUsers) {
		...
		// TODO: json convention: {allusers: allusers}
		res.json(allUsers);
	});
});


//TODO: look up express routers. TOTALLY OPTIONAL
...
app.post('/users', function (req, res) {
	//TODO: Could you pass in req.body as a variable and pull  out these attributes on the method's side?
	User.createSecure(eq.body.email, req.body.password, req.body.username, function (err, newUser) {
